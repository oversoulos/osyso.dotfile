...
"nvme"
# For your PELADN 476GB NVMe drive
"xhci_pci" # For USB 3.0 ports
"ahci"
# For standard SATA controller interfaces
"usbhid"
# For your C-Media Audio Adapter & peripherals
"usb_storage"
"sd_mod"
# For SCSI/SATA disk support
];
boot.initrd.kernelModules = [ "amdgpu" ]; # Early KMS loading for smooth AMD graphics boot
boot.kernelModules = [ "kvm-amd" ];
# Hardware virtualization for AMD Zen 3
boot.kernelParams = [ "amdgpu.sg_display=0" ];
environment.sessionVariables = {
NIXOS_OZONE_WL = "1";
Page 10 of 31File: MASTER_AI_DUMPv3.txt
};
...
Page 11 of 31File: MASTER_AI_DUMPv3.txt
