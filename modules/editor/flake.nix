    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in {
        devShells = {
          ...
          video = pkgs.mkShell {
            buildInputs = with pkgs; [
              shotcut    # Lightweight video compositor/cutter (cleaner footprint than Kdenlive/DaVinci)
        ...
        # Default fallback drops into your graphics suite automatically
        devShells.default = this.devShells.graphics;
      });
}
